...
/* FILE BASE LOCATIONS (no trailing slash!)
   These parameters are used for loading and storing images from and 
	...
	define("IMAGEBASEURL",$CMS_ENV['base_url_uploads']);
	define("IMAGEBASEPATH",$CMS_ENV['root_path_uploads']);
	define("IMAGEDIRSEPARATOR",$CMS_ENV['dir_separator']);
...
/* FONT FILE LOCATION (no trailing slash!)
   ...
   define("IMAGEFONTDIR","C:\\WINNT\\fonts");
...
*/
  ...
  define("IMAGEJPEGQUALITY", $CMS_EXTRA['jpg_compression']);
?>