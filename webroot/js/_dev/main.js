 ...
 * http://www.codrops.com
 *
 * Adjusted because too restrictive
 */
;( function( $, window, undefined ) {
	...
	$.HoverDir.prototype = {
		...
		_loadEvents : function() {
			...
			this.$el.on( 'mouseenter.hoverdir, mouseleave.hoverdir', function( event ) {
				...
				if( event.type === 'mouseenter' ) {
					...
					if (self.options.useClasses) {
						$el.addClass(self._getDirClass(direction))
					...
					if (self.options.useClasses) {
						$el.removeClass('left').removeClass('top').removeClass('right').removeClass('bottom');
						$el.addClass(self._getDirClass(direction))
		...
		_getDirClass : function(direction) {
			switch( direction ) {
				case 0:
					return 'top';
				case 1:
		...
		_getDirClassReversed : function(direction) {
			switch( direction ) {
				case 0:
					return 'bottom';
				case 1:
...
},{"../lib/appear/jquery.appear.js":1,"../lib/dotdotdot/jquery.dotdotdot.min.js":2,"../lib/hoverdir/jquery.hoverdir.js":3,"../lib/owl-carousel/owl.carousel.min.js":4,"../lib/skrollr/skrollr.min.js":5,"../lib/typing/jquery.typing-0.2.0.min.js":6,"./modules/CollapseMenu.js":8,"./modules/MainMenu.js":9}],8:[function(require,module,exports){
/**
 * Collapse Menu
 *
