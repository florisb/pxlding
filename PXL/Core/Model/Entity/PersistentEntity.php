<?php
	...
	/**
	 * Abstract PersistentEntity class.
	 * 
	 * Abstract implementation of iPersistentEntity, which
	 * stores entities in session. Persistent entities have
	 * a maximum of one instance per explicit class.
	 *
	 * @abstract
	 * @extends BaseEntity
	 * @author Max van der Stam <max@pixelindustries.com>, Kasper Mol <kasper@pixelindustries.com>
	 */
	abstract class PersistentEntity extends AbstractEntity implements iPersistentEntity {
